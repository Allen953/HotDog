...
ros::Publisher chatter("Arduino_ex", &str_msg);
std_msgs::String str_msg1;
ros::Publisher chatter1("IMU", &str_msg1);
...
char hello[20] = "arduino_ex alive!";

 
 
void setupWiFi()
{
  WiFi.setHostname("arduino_ex");
